...
public:
    ...
    //FORMATEO
    const int SIZE_SPB = sizeof(disco::Superblock);
    const int SIZE_I = sizeof(disco::Inode);
    const int SIZE_J = sizeof(disco::Journaling);
    //MISMO TAMANIO
    const int SIZE_AB = sizeof(disco::Archiveblock);
    const int SIZE_FB = sizeof(disco::Folderblock);
